...
class FakeDataset(data.Dataset):
    def __init__(self, size = 1000, image_size=(20,20,16), num_classes = 2, transform = None, target_transform = None, random_offset = 0):
        self.size = size
...
class M2(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Conv3d(1,32, (7,7,5)) # in_channel, out_channel, kernel
        self.pool = nn.MaxPool3d((2, 2, 2),2) # kernerl, stride
        self.conv2 = nn.Conv3d(32, 64, (5,5,3)) # in_channel, out_channel, kernel
        self.fc1 = nn.Linear(64 * 5 * 5 * 3, 500)
